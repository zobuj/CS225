...
TEST_CASE("NimLearner(10) constructor creates a starting vertex \"p1-10\"", "[weight=1][x][part=1]") {
  NimLearner nim(10);
...
TEST_CASE("NimLearner(1) plays a trivial random game", "[weight=1][p][part=2]") {
  NimLearner nim(1);
...
TEST_CASE("NimLearner(4) has ending edge weights summing to the random games played", "[weight=1][t][part=3]") {
  NimLearner nim(4);
